...
Acme Cloud is a modular cloud platform with services communicating over an event bus and REST/gRPC APIs.
...
## Storage Boundaries
- **PostgreSQL**: Stores primary operational state across database clusters with read replicas.
- **Redis**: Provides short-lived caching and distributed locking.
- **Object Storage**: Houses file assets and audit archives with immutable bucket versioning.

## Guarantees and Resilience
- Inter-service messaging provides at-least-once delivery with idempotent consumers.
