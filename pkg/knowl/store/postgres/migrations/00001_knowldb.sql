...
CREATE INDEX knowl_operations_scope_status
    ON knowl_operations(scope, status, updated_at);
...
CREATE INDEX knowl_pages_search
    ON knowl_pages USING GIN(search_vector);
